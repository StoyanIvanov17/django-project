# Generated by Django 5.2 on 2025-05-12 10:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='products.itemtype')),
                ('item_type_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='products.itemtypemodel')),
